...
class BrainTopographyPlotter:
    ...
    def run_analysis(self):
        ...
        # 读取数据
        df = self.load_and_process_data("save_csv/data/process_filename_frequency_distribution_median.tsv")
        ...
        for state in ['open-eyes', 'close-eyes']:
            ...
            self.plot_topomap(
                ...
                f"./save_jpg/Map/Frequency/POD_vs_noPOD_{state}_pvalue_map.jpg",
                'p_value'
            )
            ...
            self.plot_topomap(
                ...
                f"./save_jpg/Map/Frequency/POD_vs_noPOD_{state}_difference_map.jpg",
                'difference'
            )
            ...
            self.plot_topomap(
                ...
                f"./save_jpg/Map/Frequency/{state}_age_correlation_map.jpg",
                'correlation'
            )
        
        # 合并所有结果并保存到CSV
        all_results_df = pd.concat(all_results, ignore_index=True)
        all_results_df.to_csv("./save_csv/Map/Frequency/features_statistics_results.csv", index=False)
